...
class Card(models.Model):
    ...
    supertype = models.CharField(max_length=1000, blank=True, null=True)

    subtypes = models.CharField(max_length=1000, blank=True, null=True)

    set = models.CharField(max_length=1000, blank=True, null=True)

    hp = models.CharField(max_length=1000, blank=True, null=True)

    rarity = models.CharField(max_length=1000, blank=True, null=True)
